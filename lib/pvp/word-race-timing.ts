 ...
 *
 * This is a separate file because the board needs these numbers to size its
 * countdown, and importing them from lib/pvp/word-race.ts, where they used to
 * live, pulled that module into the client bundle, and with it
 * `./word-race-words`: all 478 words and their hints, shipped to every
 * player.
 *
