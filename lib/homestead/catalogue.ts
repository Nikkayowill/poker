 ...
 * exception: `homesteadPlotPrice`, which is Gold. That split is the feature's
 * whole safety story and is worth stating plainly.
 *
 * - Bushels never leave the Homestead. Seed, stock, feed and muck are all
 ...
 * a reason to enter the Homestead at all rather than only ever leaving it
