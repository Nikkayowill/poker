 ...
 *
 * Raised 5,000 -> 15,000 on 2026-09-03, then 15,000 -> 50,000 on 2026-09-05
 * (both Kayo's call). The first move was sized against the other faucets --
 * the daily grant at 1,000 x up to a 2.5 streak multiplier, rewarded ads at
 * 500 x 6 = 3,000, the backstop at 1,000 per 12h -- because at the time the
 * farm had nothing to spend Gold ON and its output was pure addition to the
 * money supply. That changed: a Cattle Pen is 60,000 Gold and a maxed
 * capacity ladder is far more, so the farm is a net SINK for anyone building
 * one, and 15,000/day made the payback on that stock too slow to be worth
 * running for. 50,000 is close to a maxed Cattle Pen's own price in a single
 * day, still flat and still per-player -- see below.
 *
 ...
 * ~18.25M a year for somebody who maxes it every single day. What bounds the
