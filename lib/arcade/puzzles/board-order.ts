 ...
 * this back, so nothing here can affect a guess, a mistake or a payout: it is
 * the arrangement of the same sixteen (then twelve, then eight...) words the
 * board already shows. That is what makes it safe to live client-side, and
 ...
 *
 * `alignSelectionInline` is the first press of Shuffle while tiles are
 ...
 * -- it is how you check whether four words look like each other before
