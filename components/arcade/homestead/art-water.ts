...
import { POND, POND_SAND, pondBounds, type Ellipse } from "@/lib/homestead/water";
import { powerOfTwoCeil, seededRandom } from "@/lib/homestead/world";
import {
  ART_FRAME,
  GRASS_PX,
  ell,
...
export function bakePondTexture(scene: Phaser.Scene): PondBake | null {
  ...
  if (texW > 2048 || texH > 2048) {
    console.warn(`homestead: pond would bake at ${texW}x${texH}; skipped`);
    return null;
  }
