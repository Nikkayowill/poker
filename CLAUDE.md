...
### The wind bed was still too loud after its first cut (2026-09-04)
Same day as the soundscape landing above: Kayo flagged wind again by ear after the ceiling had already been cut once (0.16..1.0 -> 0.09..0.55). Cut again to 0.05..0.3. Likely reason the first cut wasn't enough: wind's 400Hz bandpass sits right on top of `air`'s own 420Hz lowpass floor, reinforcing it in a way a same-bed-vs-other-beds ceiling comparison doesn't catch. Bed levels here are ear-tuned, not derived — a fix that looks right on paper against the other beds can still be wrong against the whole mix playing at once.
