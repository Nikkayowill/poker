 ...
 * /api/admin/stackacres-access. Profiles are what the dashboard lists and what
 ...
 */
export function stackacresLocked(): NextResponse {
  return NextResponse.json(
    { error: "The StackAcres is not open to you yet.", locked: true },
    { status: 401 },
  );
}
