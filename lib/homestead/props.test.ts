...
import { PROP_PAINTERS } from "@/components/arcade/homestead/art-props";
import { FARM_PATHS, PATH_CLEARANCE, distanceToPath, nearPath } from "./paths";
import { POND, POND_SAND, pondRadial } from "./water";
import { FARM_ZONE, HOMESTEAD_CELL, HOMESTEAD_MARGIN, HOMESTEAD_WORLD_COLUMNS, HOMESTEAD_WORLD_ROWS, inFarmZone } from "./world";
...
/** What paintBarn stands in the yard, as boxes (see homestead-scene.ts). */
const BARN_PIECES = [
