...
export default function TableLayoutDevPage() {
  return (
    <div style={{ background: "#08090c", minHeight: "100vh", padding: 24, display: "flex", flexDirection: "column", gap: 32 }}>
      ...
      <TableAnchorsDebug frame={DESKTOP_LANDSCAPE_FRAME} label="Desktop landscape (1600x900)" seatArt="character4" />
      <TableAnchorsDebug frame={MOBILE_LANDSCAPE_FRAME} label="Mobile landscape (844x390)" seatArt="character4" />
    </div>
  );
}
